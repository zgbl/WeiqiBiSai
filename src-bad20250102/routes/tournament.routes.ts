...
router.delete('/:id/players/:playerId', tournamentController.removePlayer.bind(tournamentController));

// McMahon 系统相关的新路由
router.post('/:tournamentId/start', tournamentController.startTournament.bind(tournamentController));
router.post('/:tournamentId/rounds', tournamentController.generateRound.bind(tournamentController));
router.post('/matches/:matchId/result', tournamentController.recordMatchResult.bind(tournamentController));
router.get('/:tournamentId/standings', tournamentController.getTournamentStandings.bind(tournamentController));

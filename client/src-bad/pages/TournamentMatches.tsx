                      ...
                      <Typography>
                        ...
                        <Typography component="span" color="text.secondary" sx={{ ml: 1 }}>
                          ...
                          {tournament.format === 'MCMAHON' && (
                            <>
                              {' | '}Group: {tournament.playerStats?.find(
                                (p) => p.playerId.toString() === match.player1?._id.toString()
                              )?.group || ''}
                              {' | '}Score: {tournament.playerStats?.find(
                                (p) => p.playerId.toString() === match.player1?._id.toString()
                              )?.currentScore || 0}
                            </>
                          )}
                      ...
                      <Typography>
                        ...
                        <Typography component="span" color="text.secondary" sx={{ ml: 1 }}>
                          ...
                          {tournament.format === 'MCMAHON' && (
                            <>
                              {' | '}Group: {tournament.playerStats?.find(
                                (p) => p.playerId.toString() === match.player2?._id.toString()
                              )?.group || ''}
                              {' | '}Score: {tournament.playerStats?.find(
                                (p) => p.playerId.toString() === match.player2?._id.toString()
                              )?.currentScore || 0}

        ...
        <Box key={roundIndex} sx={{ mb: 4 }}>
          ...
          {round.matches && round.matches.length > 0 ? (
            round.matches.map((match, matchIndex) => (
              <Card key={matchIndex} sx={{ mb: 2, boxShadow: 2 }}>
                <CardContent>
                  <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={5}>
                      <Box>
                        <Typography>
                          ...
                          {tournament.format === 'MCMAHON' && match.player1?.mcMahonScore !== undefined && (
                            <Typography component="span" color="text.secondary" sx={{ ml: 1 }}>
                              {match.player1.mcMahonScore}分
                            </Typography>
                          )}
                        </Typography>
                    ...
                    <Grid item xs={5}>
                      <Box>
                        <Typography>
                          ...
                          {tournament.format === 'MCMAHON' && match.player2?.mcMahonScore !== undefined && (
                            <Typography component="span" color="text.secondary" sx={{ ml: 1 }}>
                              {match.player2.mcMahonScore}分
                            </Typography>
                          )}
                        </Typography>
                    ...
                    {!match.winner && tournament.status === 'ONGOING' && (
                      <Grid item xs={12}>

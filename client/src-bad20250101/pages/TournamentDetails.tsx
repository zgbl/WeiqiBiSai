...
const TournamentDetails = () => {
  ...
  const handleAddPlayer = async () => {
    try {
      ...
      if (isNewPlayer) {
        ...
        const playerResponse = await axios.post(`${API_BASE_URL}/tournaments/players`, newPlayer);
  ...
  const handleStartTournament = async () => {
    try {
      ...
      await axios.post(`${API_BASE_URL}/tournaments/${id}/rounds`);
                  ...
                  {tournament.status.toUpperCase() === 'UPCOMING' && (
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          await axios.post(`${API_BASE_URL}/tournaments/${tournament._id}/rounds`);
                          await fetchTournament();
                        } catch (error: any) {
                          console.error('Error starting tournament:', error);
                          setError(error.response?.data?.message || 'Failed to start tournament');
